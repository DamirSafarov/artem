...
window.addEventListener('click', function (event) {
	...
	else if (event.target.classList.contains('sub-menu')) {
...
// let subTab = document.querySelectorAll('.navigation-list__link'),
// 	subContent = document.querySelectorAll('.sub-menu');

// 	subTab.forEach(function (sTab) {
// 		sTab.addEventListener('click', e=>{
// 			hideSubTab()
// 			e.target.closest('li').querySelector('.sub-menu').classList.add('active')
// 			document.querySelector("html").classList.add("lock");
// 		 })
// });

// function hideSubTab() {
// 	subContent.forEach((items) => {
